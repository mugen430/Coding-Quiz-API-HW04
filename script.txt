var questions = [
    ...
    {
      question: "2. The cow had 3 apples, the crow took 2, how many does the cow have left?",
      choices: [
        "3",
        "1",
        "2",
    ...
    {
      question:
        "3. if chelsea sells sea shells by the sea shore, then where was chelsea from?",
      choices: [
          "With the nazgul", 
          "by the bay", 
          "atlantis", 
    ...
    {
      question: "4. what is 2+2-4 equal to?",
      choices: [
            "1738",
            "0",
            "43",
